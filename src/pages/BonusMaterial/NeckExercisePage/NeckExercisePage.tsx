...
import styles from './NeckExercisePage.module.scss';
    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          {links && data && (
            <Navigation
              isPreviousDisabled={id === `${links[7].links[0].id}`}
              isNextDisabled={id === `${links[7]?.links?.at(-1)?.id || ''}`}
              path="neckExercises"
              id={data.id}
              links={links[7].links}
